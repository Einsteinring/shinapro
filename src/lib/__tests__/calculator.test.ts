...
const testPricing: PricingConfig = {
  ...
  roundTo: 1,
  vehicle: {
    sedan: { label: "Легковой", hint: "", multiplier: 1 },
    suv: { label: "SUV", hint: "", multiplier: 2 },
    minivan: { label: "Минивэн", hint: "", multiplier: 3 },
    lcv: { label: "LCV", hint: "", multiplier: 4 },
  },
  wheelType: {
    steel: { label: "Штамп", hint: "", multiplier: 1 },
    alloy: { label: "Литые", hint: "", multiplier: 1.5 },
    lowprofile: { label: "Low", hint: "", multiplier: 2 },
  },
  perWheelByBand: {
    "r13-15": { removeInstall: 100, mountDemount: 200, balancing: 300, punctureRepair: 400 },
    "r16-17": { removeInstall: 110, mountDemount: 210, balancing: 310, punctureRepair: 410 },
    "r18-19": { removeInstall: 120, mountDemount: 220, balancing: 320, punctureRepair: 420 },
    "r20-22": { removeInstall: 130, mountDemount: 230, balancing: 330, punctureRepair: 430 },
  },
